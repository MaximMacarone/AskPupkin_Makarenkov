...
console.log(container.dataset.wsUrl)
console.log("bebra")
console.log(container.dataset.token)
...
sub.on('publication', function (ctx) {
  ...
  templateHTML = templateHTML
    ...
    .replace(/%% content %%/g, ctx.data.text_content)
    .replace(/%% likes_count %%/g, ctx.data.votes_total)
